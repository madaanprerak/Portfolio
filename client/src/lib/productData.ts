export const productData = [
  {
    ...
    longDescription: 'PubC is a strategic product initiative that transforms TNQ\'s service offerings into a centralized, user-driven platform. It integrates project tracking, communication, and reporting under a single interface, becoming the face of TNQ and redefining how publishing services are delivered and experienced.',
    icon: 'fa-book',
  ...
  },
  {
    ...
    company: 'Dubpro.ai',
    category: 'AI + Human',
    description: 'AI-powered video dubbing platform with human-in-the-loop workflows for seamless audio localization.',
    longDescription: 'Dubpro.ai is an AI-powered video dubbing platform with human-in-the-loop workflows for seamless audio localization. It enables content creators and businesses to expand their reach globally through high-quality, cost-effective voice localization.',
    icon: 'fa-language',
  ...
  },
  {
    id: 'mgrant',
    name: 'MGrant',
    company: 'Dhwani Rural Information System Pvt Limited',
    category: 'CSR Reporting',
    description: 'Grant Management System to simplify grants for nonprofits.',
    longDescription: 'MGrant is a Grant Management System that simplifies grants for nonprofits. It provides corporate CSR teams and nonprofits with a comprehensive solution for grant management, impact tracking, and regulatory reporting, streamlining the entire CSR lifecycle from program design to impact assessment.',
    icon: 'fa-chart-pie',
    ...
    achievements: [
      'Established partnerships with 5 of 20 top CSRs including Godrej, HDFC, and Mahindra Group',
      ...
      'Generated 2 Cr additional annual revenue through strategic partnerships'
    ],
    features: [
  ...
  },
  {
    ...
    company: 'Dhwani Rural Information System Pvt Limited',
    category: 'Learning',
    description: 'Learning Management System specifically tailored for nonprofit organizations.',
    longDescription: 'MLearn is a Learning Management System specifically tailored for nonprofit organizations. It enables efficient training of field workers in rural areas with limited connectivity, combining offline capabilities with low-bandwidth optimized content delivery.',
    ...
    approach: 'MLearn was developed with a deep understanding of the nonprofit sector\'s unique challenges. We created a platform that combines modern learning techniques with practical considerations for rural deployment, ensuring that knowledge reaches even the most remote team members.',
    process: [
      {
        title: 'Analyze',
        description: 'Studied nonprofit training needs and field connectivity constraints'
      },
      {
        title: 'Optimize',
        description: 'Designed content formats for minimal bandwidth and maximum retention'
      },
      {
        title: 'Deploy',
        description: 'Implemented with field-focused training and support'
      }
    ],
    learnings: 'MLearn taught me that true accessibility means designing not just for different devices, but for entirely different contexts. By truly understanding field workers\' daily reality, we created a learning tool that fit seamlessly into their workflow rather than disrupting it.'
  },
  {
    id: 'mform',
    name: 'MForm',
    ...
    description: 'User-friendly form builder designed for non-technical users in rural areas.',
    longDescription: 'MForm is a user-friendly form builder designed for non-technical users in rural areas. It provides a robust, flexible data collection platform for field workers in rural and low-connectivity areas, enabling organizations to gather critical impact data even in offline environments.',
    icon: 'fa-mobile-alt',
  ...
  },
  {
    ...
    process: [
      {
        title: 'Discover',
        description: 'Researched pain points for both fitness seekers and service providers'
      },
      {
        title: 'Match',
        description: 'Developed intelligent algorithms to connect users with the right services'
      },
      {
        title: 'Expand',
